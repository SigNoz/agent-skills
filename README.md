...
| [signoz-setting-up-observability](plugins/signoz/skills/signoz-setting-up-observability/SKILL.md) | Orchestrate the full post-ingestion observability setup for a service — SLI/SLO capture, RED/USE exploration, dashboard, saved views, burn-rate alerts, and a tuning loop — sequencing the single-artifact skills into one SLO-aware workflow. |
