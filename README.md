...
| [signoz-reducing-telemetry-cost](plugins/signoz/skills/signoz-reducing-telemetry-cost/SKILL.md) | Investigate and reduce SigNoz telemetry ingestion cost and metric cardinality across metrics, logs, and traces — via the Cost Meter, with dashboard-, alert-, and Infra-page-aware drop/sampling recommendations. |
