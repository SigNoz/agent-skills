#!/usr/bin/env python3
"""Regenerate ``skills/dashboard-create/templates.json`` from the upstream repo.

Usage:
    python scripts/regenerate_index.py --sha <commit-sha> \
        [--output skills/dashboard-create/templates.json]
